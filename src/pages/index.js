  ...
  return (
    <Wrapper>
      ...
      <Section>
        ...
        <LightText>
          88年静岡県生まれ。多摩美術大学大学院 情報デザイン研究領域修了。9歳と6歳の娘がいます。高校で電子工学、大学でメディアアート、大学院でインタラクションデザインをやっていました。フリーのデザイナーを経て2013年にカンムへ入社。バンドルカードのデザインと開発を担当しました。2017年カンムを退職し、フリークアウト・ホールディングス子会社のニューライトへ。SMB向け業務改善事業のあれこれをやっていましたが撤退。2018年、STORESに入社しsoiという事業を立ち上げましたが2019年にクローズ。その後、STORES レジのプロジェクトリード、STORES 全体のデザインリードを経て、2022年にVP, Product Designに就任。2023年からはChief Product Officerとしていろいろやっています。
        </LightText>
        <Spacer size="medium" />
      </Section>
